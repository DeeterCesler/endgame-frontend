        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-md">
                    <div className={`planA plan ${props.planType === "loneWolf" ? `selected` : null}`} onClick={props.handleCheck} id="loneWolf">
                ...
                <div className="col-md">
                    <div className={`planB plan ${props.planType === "startup" ? `selected` : null}`} onClick={props.handleCheck} id="startup">
                ...
                <div className="col-md">
                    <div className={`planC plan ${props.planType === "enterprise" ? `selected` : null}`} onClick={props.handleCheck} id="enterprise">
