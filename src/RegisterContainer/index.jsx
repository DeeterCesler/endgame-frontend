        ...
        <div>
            <div className="container">
                ...
                <div className="mini-spacer"/>
                {
                    props.planType
                    &&
                    <Registration submitRegistration={props.submitRegistration} handleInputs={props.handleInputs} submitLogin={props.submitLogin} loggedIn={props.loggedIn} message={props.message} planType={props.planType} />
                }
